...
use crate::api::sector_builder::pieces::get_piece_start;
...
fn retrieve_piece_aux<'a>(
    ...
    let num_bytes = piece.num_bytes;
    let piece_start = get_piece_start(&sealed_sector.pieces, &piece.piece_key).unwrap();
